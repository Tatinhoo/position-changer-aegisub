-- Position Changer versão 0.3, feito por oTatinho (@otatinhoo)
...
-- Funciona com alguns tipos de alinhamento ({\an2} e {\an5})

local automation_name = "⭐ Position Changer v0.3 ⭐"
...
function openPresetsTab(subs, sel)
    ...
    local presetsTab = {
        ...
        { 
            class = "label", 
            label = "Em qual alinhamento você está?", 
            x = 0, y = 2 
        },
        { 
            class = "dropdown", 
